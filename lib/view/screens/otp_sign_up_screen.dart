...
class OtpSignUpScreen extends StatefulWidget {
  ...
  OtpSignUpScreen({Key? key,required this.type,required this.phoneOrEmail,required this.name}) : super(key: key);
...
class _OtpSignUpScreenState extends State<OtpSignUpScreen> {
  ...
  Widget build(BuildContext context) {
    final ref = Provider.of<OtpSignUpProvider>(context,);
                              ...
                              onPressed: ()async{
                                ...
                                if (textEditingController.text.isNotEmpty) {
                                  ...
                                  CherryToast(
                                      ...
                                      title:  const Text(""),
                                      displayTitle:  false,
                                      description: const Text("برجاء ادخال كود التفعيل",style: TextStyle(fontSize: 12),),
                                      toastPosition: POSITION.bottom,
                                      animationDuration: const Duration(milliseconds:  1000),
                                      toastDuration: const Duration(seconds:  5),
                                      autoDismiss:  true
